...
hoistedDependencies:
  ...
  /@sveltejs/vite-plugin-svelte/1.4.0_svelte@3.53.1:
  ...
  /svelte-hmr/0.15.1_svelte@3.53.1:
    svelte-hmr: private
  /svelte-preprocess/4.10.7_yc2sqdq5asyxa45xzvtdeibsfm:
    svelte-preprocess: private
  /svelte2tsx/0.5.21_svelte@3.53.1:
    svelte2tsx: private
  /synckit/0.8.4:
    synckit: private
  /tiny-glob/0.2.9:
...
pendingBuilds: []
prunedAt: Sat, 03 Dec 2022 07:15:49 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - /fsevents/2.3.2
storeDir: /home/pots/.local/share/pnpm/store/v3
